...
export default function MiddleNav() {
  ...
  return (
    <div className='relative w-full border-b border-gray-300 bg-[var(--black)]'>
      <div className='flex items-center justify-between px-[8%] py-3 lg:px-[16%]'>
        {/* Logo */}
        <Link
          href='/'
          className='Audiowide text-4xl font-bold text-white lg:text-5xl'
        >
        ...
        <div className='relative mx-0 ms-6 flex flex-1 flex-col rounded-lg bg-white lg:max-w-2xl'>
          <div className='flex items-center'>
            <input
              type='text'
              placeholder='Busque por sua arma'
              value={query}
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex flex-col'>
            ...
            <h1 className='GolosText font-semibold text-white'>12 9999-5555</h1>
          </div>
        </div>
      </div>
    </div>
